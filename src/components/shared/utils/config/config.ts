...
export const domain_app_ids = {
    ...
    'trade4beginners.site': APP_IDS.TRADE4_BEGINERS,
};
...
export const isTestLink = () => {
    return (
        ...
        window.location.origin?.includes('trade4beginners.site') ||
        isLocal()
    );
};
...
export const getDefaultAppIdAndUrl = () => {
    ...
    if (isTestLink()) {
        return { app_id: 85136, server_url }; // Hardcoded 70344 instead of APP_IDS.LOCALHOST
    }
...
export const getAppId = () => {
    return 85136; // Always return 70344 regardless of localStorage
};
...
export const generateOAuthURL = () => {
    ...
    original_url.searchParams.set('app_id', '85136');
