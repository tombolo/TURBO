...
const AppWrapper = observer(() => {
    ...
    const hash = ['dashboard', 'bot_builder', 'chart', 'dtrader', 'trade4tool', 'tradingview', 'strategies', 'strategy', 'risk'];
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div className='tutorials-wrapper'>
                                <Suspense
                                    fallback={<ChunkLoader message={localize('Please wait, loading finest tool...')} />}
                                >
                                    <Finesttool />
                                </Suspense>
                            </div>
